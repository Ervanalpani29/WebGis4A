...
var map = new ol.Map({
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/Kalsel_KelasLereng_PX_250K/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_KARHUTLA_2021_PT_1OK/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
  ...
  new  ol.layer.Tile({
	 ...
	 new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_PERMUKIMAN/MapServer',
				}),
			name: 'Trasportation',
			LegenUrl: '',
			LegentType :'ESRI',
